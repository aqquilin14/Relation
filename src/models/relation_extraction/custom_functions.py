...
from src.models.relation_extraction.rel_pipe import make_relation_extractor

# make the config work
from src.models.relation_extraction.rel_model import create_relation_model, create_classification_layer, create_instances, create_tensors
